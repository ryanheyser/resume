...
\textbf{Team:} Developer Operations and Platform Engineering \\
\vspace{-6.5pt}
\item\textit{Systems Engineering position focused on both platform management. Position includes a 24x7 on-call shift. Provide high-level customer support. Develop standard template for documentation to improve developer experience with increased ability to document team and external documentation.} \\
\vspace{-6.5pt}
\end{description}
\begin{itemize}
...
\vspace{-6.5pt}
\item\textit{Enrolled in the Technical Degree Sponsorship Program with the US Air Force as an Airman First Class to complete required service.} \\
\vspace{-6.5pt}
\end{description}
\begin{itemize}
