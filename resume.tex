...
\vspace{-9pt}
\begin{document}
Systems Engineering position focused on both platform management. Position includes a 24x7 on-call shift. Provide high-level customer support. Develop standard template for documentation to improve developer experience with increased ability to document team and external documentation.
\end{document}
\vspace{-9pt}
\begin{itemize}
...
\vspace{-9pt}
\begin{document}
Project to build and maintain homelab through Devops and Infrastructure-as-Code.
\end{document}
\vspace{-9pt}
\begin{itemize}
