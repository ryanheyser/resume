...
\begin{itemize}
  ...
  \item \textbf{Leadership:} Designed and implemented team lesson of the week program to knowledge-share through individualized lesson plans.
  \item \textbf{Leadership:} Maintain open-door policy for peer-level 1:1s.
  ...
  \item \textbf{AI \& Deliverability:} Integrated AI-assisted automation (Gemini, MCP server) into release pipelines to generate documentation and select targeted tests, improving release deliverability and reducing manual effort.
  \item \textbf{Golang Development:} Implemented terraform providers and observability tooling in Golang to streamline provisioning and monitoring.
  \item \textbf{SLOs \& Reliability:} Defined SLO/SLI targets and error-budget processes for platform services, improving availability and customer reliability.
  ...
  \item \textbf{Release Engineering:} Added canary rollouts, automated rollback gates, and deployment verification to CI/CD, cutting failed production deploys.
  \item \textbf{Cost \& Efficiency:} Led targeted monitoring cost reductions and retention tuning to reduce recurring platform spend.
  \item \textbf{Leadership \& Strategy:} Owned platform roadmap and led cross-team stakeholder alignment to deliver strategic platform outcomes.
  \item \textbf{People Leadership:} Built mentorship programs, led hiring and performance processes, and improved team ramp time and retention.
\end{itemize}
\end{description}
