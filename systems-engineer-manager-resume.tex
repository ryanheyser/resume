...
\textbf{Coaching \& Career Dev:} Ran mentorship programs and regular 1:1s to improve retention and performance.\\[ -9.5pt]
\textbf{Communication:} Presented to executives and cross-functional teams; facilitated decision-making.\\[ -9.5pt]
\textbf{Delivery \& Strategy:} Set OKRs, owned roadmaps, drove prioritization and trade-offs.\\[ -9.5pt]
\textbf{FinOps \& Budgeting:} Analyzed platform for cost-optimizations.
}
\end{flushleft}
\begin{flushright}
\parbox{\linewidth}{\raggedleft
\textbf{Hiring \& Onboarding:} Designed interview pipelines and onboarding programs reducing ramp time.\\[ -9.5pt]
\textbf{Stakeholder Management:} Aligned roadmap with product and executive priorities; managed cross-organizational initiatives.\\[ -9.5pt]
\textbf{Team Leadership:} Built and scaled platform teams; mentoring, peer-level performance reviews.\\[ -9.5pt]
\textbf{Technical (summary):} GCP, Kubernetes, Terraform — technical credibility to lead cloud platform teams.
}
\end{flushright}
\end{multicols}
