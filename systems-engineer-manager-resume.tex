...
\parbox{\linewidth}{\raggedright
  ...
  \textbf{Communication:} Presented to executives and cross-functional teams; facilitated decision-making.\\
  \textbf{Delivery \& Strategy:} Set OKRs, owned roadmaps, drove prioritization and trade-offs.\\
...
\parbox{\linewidth}{\raggedleft
  ...
  \textbf{Team Leadership:} Built and scaled platform teams; mentoring, peer-level performance reviews.\\
