...
\parbox{\linewidth}{\raggedright
  ...
  \textbf{CI / CD:} ArgoCD, GitHub Actions, Jenkins\\
  ...
  \textbf{DevSecOps:} HashiCorp Vault, IaC scanning, Sentinel/OPA, secrets management\\
  \textbf{Enterprise Workload Orchestration:} VMware vSphere\\
}
\end{flushleft}
\begin{flushright}
\parbox{\linewidth}{\raggedleft
  \textbf{GitOps:} Argocd, Fluxcd\\
  \textbf{Infrastructure as Code:} Ansible, Terraform\\
  \textbf{Monitoring Tools:} Grafana, Prometheus\\
  \textbf{Observability \& Tracing:} OpenTelemetry\\
  \textbf{Programming Languages:} Bash, Golang, Python\\
