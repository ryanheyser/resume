...
\begin{itemize}
  ...
  \item \textbf{AI \& Deliverability:} Leveraged AI tools (Gemini, MCP server) to automate release notes, test selection, and documentation generation — improving release deliverability and maintaining consistently high deployment success rates.
  \item \textbf{Golang Development:} Built Terraform providers, a node exporter, and cluster smoke-test tooling in Golang to increase automation, observability, and platform reliability.
  \item \textbf{SLOs \& Reliability:} Defined SLO/SLI program for platform services leading to reduced P99 latency and increased availability.
  \item \textbf{Incident Management:} Established incident response playbooks, on-call rotation, and blameless postmortems.
  \item \textbf{Cost \& Efficiency:} Led monitoring and metrics cost-optimization that reduced recurring observability spend while preserving signal quality.
  \item \textbf{Leadership \& Strategy:} Owned platform roadmap, prioritized platform investments, and aligned cross-functional stakeholders to deliver platform initiatives.
  \item \textbf{People \& Hiring:} Mentored engineers, ran hiring interviews, and structured onboarding to accelerate new-hire productivity.
\end{itemize}
\end{description}
