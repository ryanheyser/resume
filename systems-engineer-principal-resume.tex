...
\vspace{-9.5pt}
\item\textbf{CI / CD:} ArgoCD, GitHub Actions, Jenkins
\vspace{-9.5pt}
...
\vspace{-9.5pt}
\item\textbf{DevSecOps:} HashiCorp Vault, IaC scanning, Sentinel/OPA, secrets management
\vspace{-9.5pt}
\item\textbf{Enterprise Workload Orchestration:} VMware vSphere
\columnbreak
\item\textbf{GitOps:} Argocd, Fluxcd
\vspace{-9.5pt}
\item\textbf{Infrastructure as Code:} Ansible, Terraform
\vspace{-9.5pt}
\item\textbf{Monitoring Tools:} Grafana, Prometheus
\vspace{-9.5pt}
\item\textbf{Observability \& Tracing:} OpenTelemetry
\vspace{-9.5pt}
\item\textbf{Programming Languages:} Bash, Golang, Python
\vspace{-9.5pt}
\item\textbf{Service Mesh:} Istio, Linkerd
\vspace{-9.5pt}
\item\textbf{Version Control:} CVS, Git (Github.com), SVN
\end{multicols}
\end{description}
